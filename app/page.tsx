    ...
    <div className="min-h-screen" style={{ background: "#080808" }}>
      ...
      <main className="max-w-2xl mx-auto px-4 pb-12 pt-8 flex flex-col gap-6">
        ...
        <div
          ...
          style={{
            background: "linear-gradient(135deg, rgba(0,255,135,0.1) 0%, rgba(0,255,135,0.03) 100%)",
            border: "1px solid rgba(0,255,135,0.2)",
          }}
        >
          <div
            className="w-3 h-3 rounded-full flex-shrink-0"
            style={{ background: "#00ff87", boxShadow: "0 0 10px rgba(0,255,135,0.8)" }}
          />
          <div>
            <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: "#00ff87" }}>
              Recovery Status
            </p>
            <p className="text-sm mt-0.5" style={{ color: "#aaaaaa" }}>
              Your body is <span style={{ color: "#00ff87", fontWeight: 700 }}>well-recovered</span> — green light to train hard today.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="flex items-center justify-around flex-wrap gap-6">
            ...
            <Ring
              ...
              sublabel="/ 21"
              size={160}
              glowClass="ring-glow-strain"
            />
            <Ring
              value={data.sleep.performance}
              max={100}
              color="#3b82f6"
              label="Sleep"
              sublabel="perf"
              size={160}
              glowClass="ring-glow-sleep"
            />
          </div>
        </div>
